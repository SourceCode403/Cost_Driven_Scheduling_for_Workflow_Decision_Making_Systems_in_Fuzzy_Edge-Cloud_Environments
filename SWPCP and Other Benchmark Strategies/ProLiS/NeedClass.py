...
from FuzzyOperations import fuzzy_deadline
computing_capability = 12.5
...
class Task(object):
    def __init__(self, _id, server, sub_deadline):
        self._id = _id  # 任务编号
        self.server = server  # 运行的服务器编号
        self.sub_deadline = fuzzy_deadline(sub_deadline)
...
class Server(object):
    def __init__(self, environment, per_time, capability, per_cost):
        ...
        self.capability = Fuzzified_Data(capability)  # 计算能力
